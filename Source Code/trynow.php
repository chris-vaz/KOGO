...
//.......................................................................................
            ...
            if ($result->num_rows > 0){
                ...
                $verbs = array(
                    'are','were','decide','decided');

                function pronouninTheBeginning($start,$pronoun) {
                ...
                function adverbAfterpronoun($kn1,$adverb) {
...
$theword = array();
    ...
    // ----------------------------------------------------------------------------------
            ...
            $sql="SELECT Eng FROM `all_words` WHERE Eng='$word'
                ...
                $start = adverbAfterpronoun($kn1,$adverb);
                $conti = pronouninTheBeginning($start,$pronoun);
...
//Outputs "you guys great are"
            ...
            $sql="SELECT Eng FROM `all_words` WHERE Eng='$word'
                ...
                $start = adverbAfterpronoun($newsent,$adverb);
                $conti = pronouninTheBeginning($start,$pronoun);
                $Ques = quesinTheMiddle($conti,$Interrogative);
                $sentcs = verbbfoverbs($Ques,$verb);
                $trans = verbsInTheEnd($sentcs,$verbs);
...
<button id="myBtn" class="btbutton"><img src="historytrynow.png" alt="History" class="icons" /></button>
        <p id="iconlabel">History</p>
<!-- The Modal -->
...
<?php
    if($_SESSION['logged_in'] == 1){ ?>
<button onClick="location.href='discusskogo.php'" class="btbutton3"><img src="communitytrynow.png" alt="History" class="icons" /></button></centre>
<p id="iconlabel3">Community</p>
<?php }else{ ?>
<button onClick="location.href='login.php'" class="btbutton3"><img src="communitytrynow.png" alt="History" class="icons" /></button></centre>
        <p id="iconlabel3">Community</p>
<?php } ?>
    </div>
</section>
