    ...
    <div class="container">
      ...
      <div class="span-12">
        <div class="panel">
          ...
          <div class="panel-body">
  <textarea id="add_eng" name="add_eng" placeholder="<?php echo $_SESSION['English'] ?>"></textarea>
          </div>
        </div>
      </div>
      ...
      <div class="span-12">
        <div class="panel">
          ...
          <div class="panel-body">
  <textarea id="add_kon" name="add_kon" placeholder="<?php echo $_SESSION['Konkani'];?>"></textarea>
          </div>
        </div>
      </div>
      ...
      <div class="span-12">
        <div class="panel">
          ...
          <div class="panel-body">
  <textarea id="gram_type" name="gram_type" placeholder="<?php echo $_SESSION['Grammer'];?>"></textarea>
          </div>
        </div>
      </div>
