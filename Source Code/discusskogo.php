...
<textarea class="textbox1" name="eng" placeholder=" Enter your English Text here"></textarea>
<textarea class="textbox2" name="kon" placeholder=" Enter your Konkani Text here"></textarea>
